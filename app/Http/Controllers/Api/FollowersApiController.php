...
class FollowersApiController extends Controller
{
    ...
    public function followings(Request $request) {
        ...
        try {
            ...
            $base_query = $total_query = Follower::with('user')->CommonResponse()->where('follower_id', $request->id);
    ...
    public function active_followings(Request $request) {
        ...
        try {
            ...
            $base_query = $total_query = Follower::with('user')->CommonResponse()->where('follower_id', $request->id)->where('followers.status', YES);
    ...
    public function expired_followings(Request $request) {
        ...
        try {
            ...
            $base_query = $total_query = Follower::with('user')->CommonResponse()->where('follower_id', $request->id)->where('followers.status', NO);
