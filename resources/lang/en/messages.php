...
return [
	...
	"user_withdrawal_details_not_found" => "Content creator withdrawal details not found",
	"amount_is_greater_than_requested_amount" => "Amount is greater than requested amount",
	"user_withdrawal_cancelled" => "Content creator withdrawal cancelled successfully!!",
	"rejected" => "Rejected",
