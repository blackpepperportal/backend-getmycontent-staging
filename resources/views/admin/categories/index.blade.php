                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                @else
                                                    ...
                                                    <a class="dropdown-item" onclick="return confirm(&quot;{{ tr('user_product_delete_confirmation' , $category_details->name) }}&quot;);" href="{{ route('admin.categories.delete', ['category_id' => $category_details->id] ) }}">&nbsp;{{ tr('delete') }}</a>

                                                @endif

                                                @if($category_details->status == APPROVED)

                                                    <a class="dropdown-item" href="{{  route('admin.categories.status' , ['category_id' => $category_details->id] )  }}" onclick="return confirm(&quot;{{ $category_details->name }} - {{ tr('user_product_decline_confirmation') }}&quot;);">&nbsp;{{ tr('decline') }}
                                                </a> 
