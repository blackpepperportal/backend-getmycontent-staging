                                        ...
                                        <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                ...
                                                @else
                                                    ...
                                                    <a class="dropdown-item" onclick="return confirm(&quot;{{ tr('post_delete_confirmation') }}&quot;);" href="{{ route('admin.post_likes.delete', ['post_id' => $post_like->id,'user_id' => $post_like->user_id] ) }}">&nbsp;{{ tr('delete') }}</a>
