        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                ...
                <div class="card-header border-bottom border-gray">
                    ...
                    <h4 class="card-title" id="basic-layout-form">{{$sub_category->id ? tr('edit_sub_category') : tr('add_sub_category')}}</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" class="form-control" placeholder="{{ tr('name') }}" value="{{ $sub_category->name ?: old('name') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @foreach($categories as $category)
                                                <option class="select-color" value="{{$category->id}}"@if($category->is_selected == YES) selected @endif >
                                                    {{$category->name}}
                                                </option>
                                            @endforeach
                                            </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control"  id="picture" name="picture" accept="image/png,image/jpeg" src="{{ $sub_category->picture ? $sub_category->picture : asset('placeholder.png') }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="5" class="form-control" name="description" placeholder="{{ tr('description') }}">{{old('description') ?: $sub_category->description}}</textarea>
