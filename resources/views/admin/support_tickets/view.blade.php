             ...
             <div class="card-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <a class="btn btn-outline-secondary btn-block btn-min-width mr-1 mb-1 " href="{{route('admin.support_tickets.edit', ['support_ticket_id'=>$support_ticket_details->id] )}}"> &nbsp;{{tr('edit')}}</a>
                            ...
                            <div class="col-3">
                                ...
                                <a class="btn btn-outline-danger btn-block btn-min-width mr-1 mb-1" onclick="return confirm(&quot;{{tr('support_ticket_delete_confirmation' , $support_ticket_details->user)}}&quot;);" href="{{route('admin.support_tickets.delete', ['support_ticket_id'=> $support_ticket_details->id] )}}">&nbsp;{{tr('delete')}}</a>
